...
export const FileFieldFormElement = {
  type,
  construct: (id) => ({
    id,
    type,
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription className="text-muted-foreground text-xs">
                The label of the file field. It will be displayed above the field.
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription className="text-muted-foreground text-xs">
                The helper text of the file field. It will be displayed below the field.
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
          ...
          render={({ field }) => (
            <FormItem className="flex items-center justify-between rounded-lg border p-3 shadow-sm">
              <div className="space-y-0.5">
                ...
                <FormDescription className="text-muted-foreground text-xs">
                  Indicates if the file field is required. A red asterisk will appear next to the label if true.
                </FormDescription>
              </div>
              <FormControl>
                <Switch
...
function FormComponent({ elementInstance }) {
  ...
  return (
    <div className="flex flex-col gap-2 w-full">
      ...
      <Input type="file" placeholder={elementInstance?.extraAttributes?.placeholder} />
      {elements?.extraAttributes?.helperText && (
        <p className="text-[0.7rem] text-muted-foreground">
          {elements.extraAttributes.helperText}
        </p>
