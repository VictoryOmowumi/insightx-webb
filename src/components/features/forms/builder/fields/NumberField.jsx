          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription className="text-muted-foreground text-xs">
                The label of the number field. It will be displayed above
                the field
              </FormDescription>
              <FormMessage />
            </FormItem>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription className="text-muted-foreground text-xs">
                The placeholder of the number field. It will be displayed
                inside the field
              </FormDescription>
              <FormMessage />
            </FormItem>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription className="text-muted-foreground text-xs">
                The helper text of the number field. It will be displayed
                below the field
              </FormDescription>
              <FormMessage />
            </FormItem>
